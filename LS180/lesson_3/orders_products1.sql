...
--
ALTER TABLE orders ADD CONSTRAINT orders_product_id FOREIGN KEY (product_id) REFERENCES products(id);
...
-- insert a value into orders table with product_id null and no error
INSERT INTO orders (quantity)
VALUES (30);

-- drop the value and add not null constraint to product_id
DELETE FROM orders
